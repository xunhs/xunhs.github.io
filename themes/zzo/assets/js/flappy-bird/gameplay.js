...
App.Main.prototype = {
	preload : function(){
		this.game.load.spritesheet('imgBird', '/flappy-bird/img_bird.png', 36, 36, 20);
		this.game.load.spritesheet('imgTree', '/flappy-bird/img_tree.png', 90, 400, 2);
		this.game.load.spritesheet('imgButtons', '/flappy-bird/img_buttons.png', 110, 40, 3);
		
		this.game.load.image('imgTarget', '/flappy-bird/img_target.png');
		this.game.load.image('imgGround', '/flappy-bird/img_ground.png');
		this.game.load.image('imgPause', '/flappy-bird/img_pause.png');
		this.game.load.image('imgLogo', '/flappy-bird/img_logo.png');
		
		this.load.bitmapFont('fnt_chars_black', '/flappy-bird/fnt_chars_black.png', '/flappy-bird/fnt_chars_black.fnt');
		this.load.bitmapFont('fnt_digits_blue', '/flappy-bird/fnt_digits_blue.png', '/flappy-bird/fnt_digits_blue.fnt');
		this.load.bitmapFont('fnt_digits_green', '/flappy-bird/fnt_digits_green.png', '/flappy-bird/fnt_digits_green.fnt');
		this.load.bitmapFont('fnt_digits_red', '/flappy-bird/fnt_digits_red.png', '/flappy-bird/fnt_digits_red.fnt');
	},
